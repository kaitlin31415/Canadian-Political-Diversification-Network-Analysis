...
timeout = 0
#loop through each person listed and get their tweets, the for each of their tweets get how many retweets it has
for item in lines:
    ...
    if data[0] != None:
        for tweet in data[0]:
            ...
            timeout += 1
            retweets = (len(rt))
            #write it out to a file contianing the twitter handle, tweet id, and the retweets
